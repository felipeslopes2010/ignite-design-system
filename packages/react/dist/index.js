...
var AvatarFallback2 = (0, import_react2.styled)(Avatar.AvatarFallback, {
  width: "100%",
  height: "100%",
  display: "flex",
  alignContent: "center",
...
var CheckboxIndicator2 = styled(Checkbox.CheckboxIndicator, {
  color: "$white",
  width: "$4",
  height: "$4",
  '&[data-state="checked"]': {
...
var Checkbox2 = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(CheckboxContainer, __spreadProps(__spreadValues({}, props), { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(CheckboxIndicator2, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_phosphor_react2.Check, { weight: "bold" }) }) }));
};
